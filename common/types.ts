...
export type AirtableFastTrackOrder = {
  'Flight date': string
  AirlineCode: string
  Málstaðall: string
  FlightNumber: string
  ...
  Greiddi: boolean
  Upphæð: number
  Afsláttarkóði?: string
  Athugasemd?: string
  'Passenger 1 First Name': string
  'Passenger 1 Last Name': string
  'Passenger 2 First Name'?: string
  'Passenger 2 Last Name'?: string
  'Passenger 3 First Name'?: string
  'Passenger 3 Last Name'?: string
  'Passenger 4 First Name'?: string
  'Passenger 4 Last Name'?: string
}
...
export interface AirlinesFastTrack {
  delta: Airline
  united: Airline
  airCanada: Airline
...
export type FastTrackBooking = {
  departureDate: Date | undefined
  flightInformation: FlightInformation
  arrivalAirport: Airport | undefined
  customerInfo: Omit<Customer, 'phoneNumber' | 'name'>
