...
const orderTrackingPage = {
  ...
  changesSaveFailed:
    'Your changes could not be saved. Please try again or contact BagBee.',
  ...
  dayStorageTitle: 'Store your hand luggage for the day',
  dayStorageDescription:
    'Would you like us to take care of your hand luggage too? Give it to your driver at the pier and collect it later at the BSÍ Flybus terminal. From 1,500 kr per item.',
  dayStorageOpenButton: 'Add day storage',
  dayStorageSectionTitle: 'How many bags?',
  dayStorageLuggageLabel: 'Luggage items',
  dayStorageLuggageHint: 'Suitcases, sports bags — 2,000 ISK each',
  dayStorageBackpackLabel: 'Backpacks / purses',
  dayStorageBackpackHint: '≤ 50 cm with shoulder straps — 1,500 ISK each',
  dayStorageSlotLabel: 'When will you collect at BSÍ?',
  dayStorageTotalLabel: 'Total',
  dayStoragePay: 'Pay {amount} kr',
  dayStorageProcessing: 'Processing...',
  dayStorageCancel: 'Cancel',
  dayStorageSuccess:
    'Day storage booked! A BagBee driver will collect your hand luggage at the pier. Pick it up at the BSÍ counter — or, if you chose after 17:00, you’ll get a locker PIN by email.',
  dayStorageError:
    'Day-storage payment failed. Please try again or contact BagBee.',
