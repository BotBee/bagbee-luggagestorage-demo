...
const Footer = ({ navigation }: IFooterProps) => {
    ...
    <Container id="contact">
      <Content>
        ...
        <div>
          ...
          {navigation.map((link) => (
            <Link href={link.fields.href} key={link.sys.id}>
              <LinkText>{link.fields.displayText}</LinkText>
            </Link>
          ))}
        </div>
        <div>
          ...
          <ALink href="https://instagram.com/bagbee_iceland?igshid=YmMyMTA2M2Y=" target="_blank">
            <Instagram />
            <LinkText>Instagram</LinkText>
          </ALink>
          <ALink href="https://www.facebook.com/profile.php?id=100088950572823" target="_blank">
            <Facebook />
            <LinkText>Facebook</LinkText>
          </ALink>
          <ALink href="https://www.linkedin.com/company/bagbee-iceland/" target="_blank">
            <LinkedIn />
        ...
        <div>
          ...
          <LinkText>{t.footer.addressLine1}</LinkText>
          <LinkText>Vatnsmýrarvegur 10</LinkText>
          <LinkText>101 Reykjavík</LinkText>
          {t.footer.addressCountry && <LinkText>{t.footer.addressCountry}</LinkText>}
        </div>
      </Content>
      <Copyright>
        <CopyrightText>
