...
const FlightCard = ({ flight, onClick }: IFlightCardData) => {
  ...
  // Departure times are shown as Iceland wall-clock time (what the airport
  // board says), never the customer's browser timezone.
  const formatDate = (date: string) => {
    return inIcelandTime(date).format('DD/MM/YYYY')
  }

  const formatTime = (date: string) => {
    return inIcelandTime(date).format('hh:mm a')
  }
