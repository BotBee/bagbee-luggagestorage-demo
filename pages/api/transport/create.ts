...
export default async function handler(req: NextApiRequest, res: NextApiResponse) {
  ...
  try {
    ...
    // Greitt/Greiðslustaða are forced: a transport booking is never
    // pre-paid at creation, so a tampered request must not be able to
    // mark itself paid via the spread.
