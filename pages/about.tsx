...
import { IAboutPageFields, ILink } from '../@types/generated/contentful'
import en from '../common/locales/en'
import is from '../common/locales/is'
import Footer from '../components/footer/Footer'
import Header from '../components/header/Header'
import { getAboutPageContent, getNavigation } from '../modules/contentful/api'
...
`
const About = ({ data, navigation }: IAboutPageProps) => {
  const router = useRouter()
  const { locale } = router
  const t = locale === 'en' ? en : is
  const { title, textSections, heroImage, mediaLinks, staff, staffSectionText, staffSectionTitle } =
    data
          ...
          <StaffContainer>
            {staff.map((member) => (
              <StaffMember key={member.sys.id}>
                <StaffImgContainer>
                  <Image src={contentfulImage(member.fields.image)} fill alt="" />
                </StaffImgContainer>
                <div>
