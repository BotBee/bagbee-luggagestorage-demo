...
export default function BikerentPaymentSuccess() {
  ...
  useEffect(() => {
    ...
    axios.post('/api/bikerent/confirm-payment', body).finally(() => {
      router.replace(`/bikerent/${bookingId}`)
    })
      ...
      <Page>
        ...
        <Card>
          ...
          <Body>
            ...
            should appear in your email. Otherwise, please contact us.
          </Body>
