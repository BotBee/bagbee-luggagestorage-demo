...
const ArrivalPersonalInfo = () => {
  ...
  // If serviceType is 'both', customer info may already be filled from departure flow
  ...
  const onSubmit = async (values: Customer) => {
    ...
    router.push(ApplicationRoutes.arrival.confirmOrder)
  }

  return (
    <FormProvider {...methods}>
      <NextSeo title='Bagbee | Arrival contact details' />
      <FormLayout
...
export default ArrivalPersonalInfo
